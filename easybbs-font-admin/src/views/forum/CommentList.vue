            ...
            <el-dropdown trigger="click">
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  ...
                  <el-dropdown-item @click="audit(row)" v-if="row.status == 0">删除</el-dropdown-item>
                </el-dropdown-menu>
              </template>
            </el-dropdown>
          </div>
...
const delComment = (data) => {
  proxy.Confirm(`你确定审核删除评论吗？`,async () => {
    let result = await proxy.Request({
      url:api.delComment,
      params:{
